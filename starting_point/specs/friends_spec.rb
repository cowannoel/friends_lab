...
class TestFriends < MiniTest::Test
  ...
  def test_likes_to_eat
    result = likes_to_eat(@person5, "apple")
...
def test_add_friend
  add_friend(@person1, "Scrappy-Doo").length
  ...
  def test_remove_friend
    remove_friend(@person4, "Daphne").length
  ...
  def test_count_money_total
    result = count_money_total(@people)
...
def test_loan_money
loan_money(@person4, @person2, 3)
  assert_equal(17, @person4[:monies])
  assert_equal(5, @person2[:monies])
end
